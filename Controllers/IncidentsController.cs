...
namespace FireSafetyManager.Controllers
{
    public class IncidentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Incidents.Include(i => i.Vehicle);
        ...
        public async Task<IActionResult> Create([Bind("Id,Address,Type,WaterUsed,IncidentStart,IncidentEnd,VehicleId")] Incident incident)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Address,Type,WaterUsed,IncidentStart,IncidentEnd,VehicleId")] Incident incident)
        {
            if (id != incident.Id)
            {
                return NotFound();
